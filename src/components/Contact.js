                        ...
                        <form>
                            ...
                            <div className="mb-3">
                                ...
                                <div className='input-group'>
                                    ...
                                    <input type="tel" className="form-control" id="phonenumber" value={formDetails.phonenumber} placeholder='98765 12345' onChange={(e) => onFormUpdate('phonenumber', e.target.value)} pattern='[0-9]*' onInput={handleNumericInput} aria-describedby="phonenumberHelp" style={{maxWidth: "70%"}} />
                                </div>
                            </div>
                            <div className="mb-3">
